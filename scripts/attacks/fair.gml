...
set_window_value(AT_FAIR, 5, AG_WINDOW_ANIM_FRAME_START, 13);
...
set_window_value(AT_FAIR, 6, AG_WINDOW_ANIM_FRAME_START, 16);
set_window_value(AT_FAIR, 6, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FAIR, 6, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
...
set_window_value(AT_FAIR, 7, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
set_window_value(AT_FAIR, 7, AG_WINDOW_SFX_FRAME, 2);

set_window_value(AT_FAIR, 8, AG_WINDOW_LENGTH, 3);
set_window_value(AT_FAIR, 8, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_FAIR, 8, AG_WINDOW_ANIM_FRAME_START, 21);
set_window_value(AT_FAIR, 8, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FAIR, 8, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
...
set_window_value(AT_FAIR, 9, AG_WINDOW_ANIM_FRAME_START, 24);
set_window_value(AT_FAIR, 9, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FAIR, 9, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
set_window_value(AT_FAIR, 9, AG_WINDOW_SFX_FRAME, 2);
set_window_value(AT_FAIR, 9, AG_WINDOW_HAS_WHIFFLAG, 0);
